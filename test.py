...
def parse_args():
    ...
    parser.add_argument("--ckpt_url", default=r"D:\source\BGINet\output\20230828-093428\best.pth",
                        help="data root")
    parser.add_argument("--modelname", default="",
                        help="data root")
    parser.add_argument("--data_path", default=r"D:\source\data\BCDD256\test",
                        help="data root")
    parser.add_argument("--device", default="cuda", help="training device")
    parser.add_argument("--out_path", default=r"D:\source\BGINet\test_result", help="val root")
...
# model = BGINet(3, 2)
model = torch.load(args.ckpt_url, map_location=torch.device('cuda')) # TODO: 新增加的代码行
